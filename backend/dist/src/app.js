...
import { fetchTeachers, changeSelfPassword, changeTeacherPassword, deleteUser, getProfile, registerAdmin, registerTeacher, updateUser, updateSelf, autocompleteTeacher } from './services/teaching_staff.js';
import { autocompleteStudent, deleteStudent, fetchStudentInfo, filterStudentsByClassDegree, filterStudentsByDegree, findStudentByName, newStudent, updateStudent } from './services/students.js';
import { autocompleteSubject, deleteSubject, fetchSingleSubject, fetchSubjects, fetchSubjectsByTeacher, filterSubjectsByClassDegree, filterSubjectsByDegree, findSubjectByName, newSubject, updateSubject } from './services/subjects.js';
import { deleteEnrollment, fetchCourseworkGradesWithDataForSubject, fetchEnrollmentsForSubject, fetchSingleEnrollment, newEnrollment, updateEnrollment } from './services/studying.js';
import { fetchAbsentStudents, markStudentAbsent, removeAbsence } from './services/absented.js';
import { createDailyAttendanceRecord, fetchDailyAttendanceRecordsForTheSubject } from './services/attendance_record.js';
import { fetchStudentCourseworkGradesPerStudying } from './services/grading.js';
import { fetch_ta_subject_list, fetchSubjectAccessControl, grantAccess, revokeAccess } from './services/subjects_access_control.js';
