...
export class Studying extends PG_Table {
    ...
    async autoInsertStudentsForSubject(subject_id, degree, _class, studying_year, coursework_grade_percent, finals_grade_percent) {
        await this.sql `
