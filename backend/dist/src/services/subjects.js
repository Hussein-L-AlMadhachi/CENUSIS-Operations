...
// insert
export async function newSubject(metadata, data) {
...
// update
export async function updateSubject(metadata, id, data) {
    console.log(data);
    delete data["name"];
    delete data["id"];
...
// delete
export async function deleteSubject(metadata, id) {
    await subjects.delete(id);
}
// Fetching and filtering
export async function fetchSingleSubject(metadata, id) {
...
export async function fetchSubjects(metadata) {
...
export async function filterSubjectsByClassDegree(metadata, degree, subject_class) {
...
export async function filterSubjectsByDegree(metadata, degree) {
...
export async function autocompleteSubject(metadata, name) {
...
export async function findSubjectByName(metadata, name) {
...
export async function fetchSubjectsByTeacher(metadata, degree, subject_class) {
    ...
    let result;
    if (subject_class) {
        result = await subjects.filterByTeacherClassDegree(teacher.id, degree, subject_class);
        if (!result) {
            throw new Error("no subjects found");
        }
    }
    else {
        result = await subjects.filterByTeacherDegree(teacher.id, degree);
        if (!result) {
            throw new Error("no subjects found");
        }
    }
