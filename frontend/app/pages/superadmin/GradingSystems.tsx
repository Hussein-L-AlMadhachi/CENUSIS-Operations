...
function MainContent(): JSX.Element {
    ...
    const fetchData = () => {
        superAdminRPC.fetchGradingSystems().then((result) => setData(result));
    };
        ...
        <Section>
            ...
            <Subsection>
                <EditableTable
                    ...
                    onDelete={(id: number) => {
                        superAdminRPC.deleteGradingSystem(id).then(() => fetchData());
                    }}
                    onSave={(id: number, row: GradingSystemData) => {
                        ...
                        superAdminRPC.updateGradingSystem(id, {
                            name,
                            fields: row.fields
                        }).then(() => fetchData());
                    }}
...
export function SuperGradingSystemsPage(): JSX.Element {
