...
// Globals
import { type GradesDate, adminRPC } from "@/rpc";
...
function Options({ onImportSuccess, studying_id }: OptionsProps) {
    ...
    return <div className="flex justify-between flex-wrap">
        ...
        <div className="text-4xl"> إدارة درجات الطلاب </div>
...
function MainContent(): JSX.Element {
    ...
    const fetchData = () => {
        adminRPC.fetchStudentCourseworkGradesPerStudying(parseInt(params.studying_id)).then((data) => setData(data));
    };
